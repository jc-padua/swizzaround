    ...
    <div className="flex flex-col min-h-[85vh] lg:flex-row pt-8">
      <div className="lg:px-16 lg:relative lg:w-1/2 lg:flex lg:flex-col">
        <div className="flex flex-col gap-3 my-4">
          ...
          <p className="text-3xl lg:text-4xl xl:text-6xl font-bold">
            Discover The
          </p>
          <p className="text-3xl lg:text-4xl xl:text-6xl font-medium">
            Best Destinations
          </p>
          <p className="text-3xl lg:text-4xl xl:text-6xl font-medium mb-4">
            In Switzerland
          </p>
          ...
          <div className="lg:absolute lg:bottom-12 xl:bottom-32 lg:z-10 lg:w-[45rem] bg-white w-full rounded-lg shadow-[0_7px_60px_-15px_rgba(0,0,0,0.3)]">
      ...
      {screenSize <= 1024 ? (
        ...
        <div className="lg:w-1/2 lg:grid lg:grid-cols-2 lg:grid-rows-2 gap-4 ">
          <div className=" relative flex items-end justify-self-end">
            <img
              className="w-72 xl:w-56 aspect-auto rounded-2xl shadow-[0_7px_60px_-15px_rgba(0,0,0,0.3)]"
              src={switzPortrait1}
              alt=""
            />
            <div className="absolute bottom-7 -left-52 backdrop-blur-xl bg-blue-400/20 px-10 py-6 xl:py-4 xl:px-4 w-64 text-center rounded-lg shadow-[0_7px_60px_-15px_rgba(0,0,0,0.3)]">
          ...
          <div className=" flex items-end relative">
            <div className="absolute top-10 left-10  backdrop-blur-xl bg-blue-400/20 px-5 py-4 text-center rounded-lg shadow-[0_7px_60px_-15px_rgba(0,0,0,0.3)]">
          ...
          <div className="row-start-2 flex justify-end">
            <img
              className="rounded-2xl h-80 xl:h-48 aspect-auto shadow-[0_7px_60px_-15px_rgba(0,0,0,0.3)]"
              src={switzLandscape2}
              alt=""
            />
          </div>
          <div className=" row-start-2 aspect-auto">
            <img
              className="w-80 xl:w-56 rounded-2xl shadow-[0_7px_60px_-15px_rgba(0,0,0,0.3)]"
              src={switzPortrait2}
              alt=""
            />
          </div>
